...
const Process = () => {
    return (
        <div>
            ...
            <h1 className="font-bold text-center text-3xl font-display border-2 px-6 py-4 uppercase my-8 w-1/2 mx-auto border-b-2 border-teal-950 pb-4">How Chakri Bazar Works For You</h1>
            <div className="flex justify-between items-center gap-4 mx-10 mb-10">
                ...
                <div className="flex flex-col justify-center shadow-xl p-6 hover:border-2 border-teal-950 mt-12">
